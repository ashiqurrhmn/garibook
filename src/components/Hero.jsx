    ...
    <section ref={heroRef} className="relative w-full flex flex-col">
      ...
      <div className="w-full bg-white pt-8 md:pt-20 pb-65 px-4 sm:px-6 lg:px-8 z-0">
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div
            ref={leftTextRef}
            className="w-full lg:w-1/2 mb-6 md:mb-0 lg:mb-0"
          >
            <h1 className="text-[36px] md:text-[46px] lg:text-[64px] font-bold text-gray-900 leading-[1.1] tracking-tight min-h-[90px] md:min-h-[80px] lg:min-h-[150px]">
              {displayText}
              <span className="text-garibook-blue font-light animate-pulse ml-1">
                |
              </span>
            </h1>
          </div>
          ...
          <div ref={rightContentRef} className="w-full lg:w-1/2">
            ...
            <a
              href="#"
              className="bg-[#FDD300] hover:bg-[#e5be00] text-black font-semibold text-[18px] md:text-[20px] py-[16px] md:py-[20px] lg:py-[25px] px-[24px] md:px-[30px] rounded-[16px] flex items-center justify-between w-[270px] md:w-[290px] mt-6 lg:mt-6 transition-colors shadow-sm"
            >
      ...
      <div className="w-full bg-[#1252FF] relative z-10 pt-10 pb-10">
        <div
          ref={cardRef}
          id="booking-card"
          className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 -mt-55 relative z-20"
        >
          <BookingCard />
        </div>
      </div>
