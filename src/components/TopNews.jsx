...
const TopNews = () => {
  ...
  const newsItems = [
    {
      ...
      description: "বাংলাদেশে ইন্টারসিটি ভ্রমণ সহজ ও সাশ্রয়ী করার লক্ষ্যে একটি অনন্য উদ্যোগ নিয়ে এসেছে 'গাড়িবুক'। কোনো কমিশন ছাড়াই ইন্টারসিটি কার রেন্টাল পরিষেবা দেওয়া গাড়িবুক দেশের প্রথম এবং একমাত্র অ্যাপ।",
    ...
    },
    {
      ...
      description: 'For the first time in Bangladesh, tourists can now book the iconic Chander Gari through an online platform.',
    ...
    },
    {
      ...
      description: "বাংলাদেশে পর্যটকদের জন্য জনপ্রিয় যানবাহন 'চান্দের গাড়ি' এবার যুক্ত হলো অনলাইন অ্যাপ ভিত্তিক প্ল্যাটফর্মে। গাড়িবুক দেশের প্রথম অ্যাপ হিসেবে পর্যটকদের জন্য এই বিশেষ যানটি বুকিং সুবিধা নিয়ে এলো।",
    ...
    },
    {
      ...
      title: 'গাড়িবুক ও সুধীর চুক্তি - স্মার্ট চালক ও পরিবারের জন্য উন্নত স্বাস্থ্যসেবা',
      description: "দেশের শীর্ষস্থানীয় অ্যাপভিত্তিক প্ল্যাটফর্ম গাড়িবুক স্মার্ট চালক ও তাদের পরিবারের উন্নত স্বাস্থ্যসেবা নিশ্চিত করতে ডিজিটাল স্বাস্থ্যসেবা প্ল্যাটফর্ম 'সুধী'-এর সঙ্গে একটি গুরুত্বপূর্ণ চুক্তি স্বাক্ষর করেছে। এই উদ্যোগের মাধ্যমে চালকরা ও তাদের পরিবার সহজেই স্বাস্থ্যসে...",
      logo: '/Assets/Top-news/kalerkantha-logo.png',
      link: '#'
    }
  ];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-white py-6 md:py-12 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-0 flex flex-col">
        
        {/* Header Section */}
        <div className="gsap-news-up flex flex-col lg:flex-row justify-between items-start lg:items-end mb-10 md:mb-12">
          <h2 className="text-[#222222] text-[32px] md:text-[40px] lg:text-[48px] font-bold tracking-tight leading-[1.1] mb-6 lg:mb-0">
            We Featured by Top news<br className="hidden lg:block" /> Platforms
          </h2>
        ...
        >
          {newsItems.map((news) => (
            <div 
              key={news.id} 
              className="gsap-news-up flex-shrink-0 w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-21px)] snap-start flex flex-col"
            >
              {/* Image */}
